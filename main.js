$(document).ready(function () {
  ...
  masterData.section_name.map((section, key) => {
    window.firstSection = key
    ...
    $('#' + id).caphList({
      items: innerData,
      template: '<div class="item item1" focusable data-name="<%= item.name %>" data-story="<%= item.story %>" on-focused="focus($event)" data-focusable-depth="0" data-focusable-initial-focus="<%=(index===0) && ( window.firstSection ===0 )?true:false%>"> <img style="width:100%; height:100%" src="<%= item.poster_url %>"></img></div>',
      containerClass: 'list',
    })
  });
})
